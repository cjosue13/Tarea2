...
public class Excel {
    ...
    public void SendMail() throws MessagingException, IOException {
        ...
        mensaje.addRecipient(Message.RecipientType.TO, new InternetAddress("solomaj12@gmail.com"));// Destinatario
        mensaje.setSubject("Asunto");// Aqui podemos escribir el asunto que necesitemos en el correo
